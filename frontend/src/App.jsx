  ...
  return (
    <main className="entry-screen">
      ...
      <section className="entry-card pixel-panel">
        ...
        <form onSubmit={(event) => { event.preventDefault(); onEnter({ name: name.trim() || '新居民', mode, ai: { baseUrl, apiKey, model, generationTimeout: Number(generationTimeout), dialogueTimeout: Number(dialogueTimeout) } }) }}>
